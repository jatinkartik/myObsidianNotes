To configure and assign a static IP using `nmcli` in Obsidian notes, you can create a note detailing the command and its options. Here's how you can structure your note:
